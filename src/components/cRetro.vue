<template>
  <div class="c-retro container mt-5">
    ...
    <div v-if="localResults" class="animate-fade-in">
      <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4" v-if="currentCompetition">
             <div class="card mb-3 shadow-sm border-secondary h-100">
      ...
      <div class="row mt-4" v-if="(localResults.consolesPlayed && localResults.consolesPlayed.length)">
        <div class="col-12">
          <div class="card">
            <div class="card-header cursor-pointer d-flex justify-content-between align-items-center" @click="showConsoles = !showConsoles" role="button">
      ...
      <div class="row mt-4" v-if="(localResults.gamesPlayed && localResults.gamesPlayed.length)">
        <div class="col-12">
          <div class="card">
            <div class="card-header cursor-pointer d-flex justify-content-between align-items-center" @click="showGames = !showGames" role="button">
...
export default {
  ...
  setup() {
    ...
    return { localResults, numConsoleCols, showConsoles, showGames, currentCompetition };
  }
};
</script>
